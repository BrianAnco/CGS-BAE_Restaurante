            ...
            try
            {
                ...
                for (int i = 0; i < dgvMesas.RowCount; i++)
                {
                    ...
                    else
                    {
                        if (Convert.ToBoolean(dgvMesas.Rows[i].Cells[2].Value) == false)
                        {
                            dgvFotos.Rows.Add(Image.FromFile("D:/Laboratorios Programación II/MesasBAE/Verde.png"), Convert.ToString(dgvMesas.Rows[i].Cells[1].Value));
                        }
                        else
                        {
                            dgvFotos.Rows.Add(Image.FromFile("D:/Laboratorios Programación II/MesasBAE/Rojo.png"), Convert.ToString(dgvMesas.Rows[i].Cells[1].Value));
                        }
                    }
